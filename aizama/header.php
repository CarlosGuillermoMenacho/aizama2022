...
<head>
  ...
  <title>AIZAMA: PRIVATE SCHOOL</title>
  <link rel="stylesheet" href="css/estiloDoc.css?v=<?echo rand();?>">
...
<header>
      ...
      <a href="#" class="bt-menu">
        ...
        <div>Menú Principal / Main Menu<span class="icon-menu" id="btn-menu"></span></div>
      </a>
    </div>
    ...
    <nav>
      <ul>
        ...
        <li class="submenu">
          <a href="#"><div class="div-name-item"><span class="icon-new-message"></span>Centralizadores</div><div class="downarrow"><span class="caret icon-chevron-down"></span></div></a>
          <ul class="children">
        ...
        <li class="submenu">
          <a href="#"><span class="icon-documents"></span>Evaluaci&oacute;n de Selecci&oacute;n<span class="caret icon-chevron-down"></a>
          <ul class="children">
        ...
        <li class="submenu">
          <a href="#"><span class="icon-new-message"></span>Notas de Exámenes de Selecci&oacute;n<span class="caret icon-chevron-down"></a>
          <ul class="children">
        ...
        <li class="submenu">
          <a href="#"><span class="icon-text-document"></span>Notas Ser y Decidir<span class="caret icon-chevron-down"></a>
          <ul class="children">
        ...
        <li class="submenu">
          <a href="#"><span class="icon-text-document"></span>Notas Trimestrales<span class="caret icon-chevron-down"></a>
          <ul class="children">
