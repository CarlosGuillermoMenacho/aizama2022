...
<link rel="stylesheet" type="text/css" href="css/top_calificaciones.css?v=<?php echo rand();?>">
<div class="div-title">
...
<script type="text/javascript" src="js/top_calificaciones.js?v=<?php echo rand();?>"></script>