...
?>
<link rel="stylesheet" type="text/css" href="css/horario_prof.css?v=<?php echo rand();?>">
...
<div class="content">
    ...
    <div class="main-div-escritorio">
        <div class="div-table-escritorio">
            <table>
                <thead>
                    <tr>
                        <td>Periodo</td>
...
<script type="text/javascript" src="js/horario_prof.js?v=<?php echo rand();?>"></script>
<script>
