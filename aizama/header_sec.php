...
<head>
  ...
  <title>Sistema SIEV-A</title>
  <link rel="stylesheet" href="css/estiloDoc.css">
  <link rel="stylesheet" href="fonts/style.css">
  <script src="js/jquery.min.js"></script>
  <script src="js/main_sec2.js?v=<?php echo(rand()); ?>"></script>
...
<header>
    ...
    <div class="menu_bar">
      <a href="#" class="bt-menu">
        ...
        <span id="user">
          <strong>
            <?=$_SESSION['curso'].' - '.$_SESSION['app_user_name'];?>
          </strong>
        </span>
    ...
    <nav>
      <ul>
        ...
        <li><a href="#" id="s_c"><span class="icon-check"></span>Salida del Colegio</a></li>
        <li><a href="#" id="cv"><span class="icon-video"></span>Clase en Vivo</a></li>
        <li><a href="#" id="ad"><span class="icon-mobile"></span>Práctica de examen</a></li>
  ...
  <!--      <li class="submenu">
        ...
        <li class="submenu">
          <a href="#"><span class="icon-laptop"></span>Rol de Exámenes<span class="caret icon-chevron-down"></span></a>
          <ul class="children">
            <li><a href="#" id="ROLA1">Primer Trimestre <span class="icon-dot"></span></a></li>
            <li><a href="#" id="ROLA2">Segundo Trimestre <span class="icon-dot"></span></a></li>
            <li><a href="#" id="ROLA3">Tercer Trimestre <span class="icon-dot"></span></a></li>
          </ul>
        </li>
        <li class="submenu">
        ...
        <li>
          <a href="#" id="BN"><span class="icon-mobile"></span>Boletín de Notas</a>
          <strong>
          <input id="examen" type="hidden" value="<?=$_SESSION['usrimple'];?>" />
          </strong><strong>
        ...
        <li><a href="#" id="CC"><span class="icon-key"></span>Cambiar Contraseña</a></li>
        <!--<li><a href="libro_materias.php" id="Libros"><span class="icon-open-book"></span>Libros Digitales</a></li>-->
        <li><a href="biblioteca.php" id="Libros"><span class="icon-open-book"></span>Biblioteca Digital</a></li>
