...
<div id="container" class="container">
    <div class="title2" id="title-pag"><h1>Evaluaciones<br><br>Gestión <?php echo (date("Y"));?></h1></div>
...
<script type="text/javascript" src="js/evaluacion_inicial_doc.js?v=<?php echo rand();?>"></script>
