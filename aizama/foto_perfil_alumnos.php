...
<div class="title"><h1>GESTIONAR FOTO DE PERFIL DE LOS ALUMNOS</h1></div>
<div id="tabla_lista" class="table-lista">
    ...
    <div style="display:none;">
        <form id="formulario">
            <input type="text" id="codalu" name="codalu">
            <input type="file" id="imagen" name="imagen" accept="image/png, image/jpg, image/jpeg"/>
        </form>
    </div>
<script type="text/javascript" src="js/foto_perfil_alumnos.js?v=<?php echo rand();?>"></script>