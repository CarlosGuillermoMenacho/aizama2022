...
?>
<link rel="stylesheet" type="text/css" href="css/evaluacion_inicial_9.css?v=<?php echo rand();?>">
...
<div id="evaluaciones" class="div-content-eval">
	<div class="div-lapiz">
		<img src="images/circlegreen.png" title="Círculo" onclick="lapiz(1);"> 
		<img src="images/equiz.png" title="Equis" onclick="lapiz(2);">
	...
	<div class="div-canvas" id="div-canvas">
		<canvas class="rojo" id="canvas"></canvas>
	</div>
	<!--div class="div-content-faces">
...
<script type="text/javascript" src="js/evaluacion_inicial_9.js?v=<?php echo rand();?>"></script>