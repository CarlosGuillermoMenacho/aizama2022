...
//	  alert('No 1');
	...
	var html=$.ajax({type:"GET",url:'grabar_prac_flia.php',data:{id1:id8,id2:id9,id3:id11,id4:id12,id5:id13,id6:id14},async:false}).responseText;
//	  alert('No 2');
...
//	alert('alumno: '+ $codalu +' pregunta: '+ $codpre);
  ...
  {
	var html=$.ajax({type:"GET",url:'get_grab_prac_flia.php',data:{id1:$codalu,id2:$codpre},async:false}	).responseText;
...
{
//		alert ('voy : ' + id);
	var html=$.ajax({type:"GET",url:'get_datos_practicar_flia.php',data:{id:id},async:false}).responseText;
...
{
//	alert ('bola 1');
	var html=$.ajax({type:"GET",url:'get_hora_flia.php',data:{id:id1},async:false}).responseText;
//	alert ('bola 2');
...
//	alert ('bola 21');
	var html=$.ajax({type:"GET",url:'get_cant_prac_flia.php',data:{id:id1},async:false}).responseText;
//	alert ('bola 22');
...
{
//	alert('cv 1');
	var html=$.ajax({type:"GET",url:'get_practicar_flia.php',data:{id:id},async:false}).responseText;
//	alert('cv 2');
...
{
	var html=$.ajax({type:"GET",url:'get_prac_mismo_flia.php',data:{id:id1,id2:id3},async:false}).responseText;
...
{
	var html=$.ajax({type:"GET",url:'grabar_aban_prac_flia.php',data:{id1:id8,id2:id9,id3:id11,id4:id12,id5:id13,id6:id14},async:false}).responseText;
...
//	  alert('No 1');
	...
	var html=$.ajax({type:"GET",url:'borrar_aban_prac_flia.php',data:{id1:id8,id2:id9,id3:id11,id4:id12,id5:id13,id6:id14},async:false}).responseText;
//	  alert('No 2');
...
function Salir()
{
		location.href='menu_familia.php';
		return true;
}
...
$(document).ready(function()
						   {
						       console.log($('#vf_numero').val());
						       console.log($('#vf_contador').val());
						       console.log($('#vf_codpre').val());
