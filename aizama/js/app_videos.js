...
//			location.href='materias1ro_p.php';   // ESTE DESHABILITE
			location.href='aviso_v.php';
		}
		else
		{
			location.href='aviso_v.php';
//			location.href='materias1ro_s.php';    // ESTE DESHABILITE
		}
	}
}
function segundo()
{
	...
	if (getAsignarBimestre($codb))
	{
		if ($('#vf_perfil').val() == 'PRIMARIA')
		{
//			location.href='materias2do_p.php';   // ESTE DESHABILITE
			location.href='aviso_v.php';
		}
		else
		{
			location.href='aviso_v.php';
//			location.href='materias2do_s.php';    // ESTE DESHABILITE
		}
	}
}
function tercero()
...
function cuarto()
{
	...
	if (getAsignarBimestre($codb))
	{
		if ($('#vf_perfil').val() == 'PRIMARIA')
		{
			location.href='materias4to_p_v.php';   // ESTE DESHABILITE
//			location.href='aviso1.php';
		}
		else
		{
//			location.href='aviso1.php';
			location.href='materias4to_s_v.php';    // ESTE DESHABILITE
		}
	}
}
