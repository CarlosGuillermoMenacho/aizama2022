...
//							   $('#btnLista').bind('click',function(){location.href='Lista.php';});
							   ...
							   $('#btn2practicar').bind('click',function(){location.href='practicar_flia.php';});

							//   $('#btnexamen').bind('click',function(){location.href='examen_primaria.php';});
							   $('#btnexamen').bind('click',function(){Examen();});
							   $('#btnvideo').bind('click',function(){location.href='videos_disponibles.php';});
							   ...
							   $('#btnbimestre4').bind('click',function(){location.href='reg_notas4.php';});
								$('#btnl_utiles').bind('click',function(){location.href='view_lista_utiles.php';});
							   $('#btnBoletin').bind('click',function(){location.href='usuario.php';});
