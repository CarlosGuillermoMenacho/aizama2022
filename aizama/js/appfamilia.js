...
//							   $('#btnCodigo').bind('click',function(){location.href='codigo_qr.php';});
							   $('#btnKardex').bind('click',function(){location.href='kardex_pago.php';});
							   $('#btnBoletin').bind('click',function(){location.href='boletinfamilia.php';});
