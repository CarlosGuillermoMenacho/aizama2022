...
//							   $('#btnLista').bind('click',function(){location.href='Lista.php';});
							   $('#btnbi1').bind('click',function(){location.href='reg_notas1.php';});
							   $('#btnbi2').bind('click',function(){location.href='reg_notas2.php';});
							   $('#btnbi3').bind('click',function(){location.href='examen2.php';});
							   $('#btnbi4').bind('click',function(){location.href='reg_notas4.php';});
