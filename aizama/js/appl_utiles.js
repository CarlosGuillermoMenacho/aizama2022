...
//							   $('#btnbimestre1').bind('click',function(){location.href='reg_practicos.php';});
//							   $('#btnbimestre2').bind('click',function(){location.href='reg_notas2.php';});
//							   $('#btnbimestre3').bind('click',function(){location.href='reg_notas3.php';});
							   $('#btn2020').bind('click',function(){location.href='curso_utiles.php';});
...
//							   $('#btnBoletin').bind('click',function(){location.href='boletin.php';});
							   $('#btnSalir').bind('click',function(){location.href='menu_familia.php';});
							}
							)
