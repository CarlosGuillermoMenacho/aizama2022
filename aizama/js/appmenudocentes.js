...
//							   $('#btnLista').bind('click',function(){location.href='Lista.php';});
							   ...
							   $('#btnb3').bind('click',function(){location.href='m_notas.php';});
...
//							   $('#btnbimestre4').bind('click',function(){location.href='reg_notas4.php';});
							   ...
							   $('#btnSalir').bind('click',function(){location.href='docentes.php';});
							   $('#btnb4').bind('click',function(){location.href='agenda.php';});
							   $('#btnb5').bind('click',function(){location.href='view_ver_agenda.php';});
							   $('#btnb6').bind('click',function(){location.href='m_videos.php';});
							   $('#btnb7').bind('click',function(){location.href='m_clases.php';});
							    $('#btnlistaUtiles').bind('click',function(){location.href='gestion_Utiles.php';});
