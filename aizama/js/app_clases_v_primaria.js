...
function lenguaje()
{
	...
	{
		location.href='ver_practicos.php?vista=1';
	}
}
...
//	alert ('hola 7');
	if (parseInt(nro_prac)>0){
		var html=$.ajax({type:"POST",url:'get_lista_clases_v_ver.php?op=lista_llena',data:{materia:codMateria,curso:codCurso},async:false}).responseText;
	}
//	alert ('hola 6.8');
...
function crearTabla(){
    ...
    tabla+='<tr align="center"><td><b>No.</b></td><td align="center"><b>DESCRIPCION DE CLASES VIRTUALES</b></td><td align="center"><b>VER CLASE V.</b></td>';
    tabla+="</tr>";
...
function CargarVideo(){
	...
	console.log(c_mat);
	var html=$.ajax({type:"POST",url:'get_lista_clases_v.php',data:{id1:n_curso,id2:c_mat},async:false}).responseText;
	if(html=='Paso2'){
