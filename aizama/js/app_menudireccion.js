...
//							   $('#btnLista').bind('click',function(){location.href='Lista.php';});
							   $('#btnb1').bind('click',function(){location.href='m_practicos.php';});
							   $('#btnb2').bind('click',function(){location.href='m_examen.php';});
							   $('#btnb3').bind('click',function(){location.href='menu1.php';});
//							   $('#btnbimestre4').bind('click',function(){location.href='reg_notas4.php';});
							   $('#btnBoletin').bind('click',function(){location.href='boletin3.php';});
							   $('#btnNotasExamen').bind('click',function(){location.href='nota_exa_bimestres.php';});
							   $('#btnSalir').bind('click',function(){location.href='administracion.php';});
							   $('#btnb4').bind('click',function(){location.href='agenda.php';});
							   $('#btnb5').bind('click',function(){location.href='view_ver_agenda.php';});
							   $('#btnb6').bind('click',function(){location.href='mensajes.php';});
							   $('#btnb7').bind('click',function(){location.href='reporte_caja.php';});
							   $('#btnb8').bind('click',function(){location.href='gestion_prof_cur_mat.php';});
							   $('#btnb11').bind('click',function(){location.href='view_reg_salida.php';});
							}
							)
