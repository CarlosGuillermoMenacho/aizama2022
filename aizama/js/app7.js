...
$(document).ready(function()
						   {
							   ...
							   $('#btnReporte').bind('click',function(){location.href='reporte_sup.php';});
							   ...
							   $('#btnReversion').bind('click',function(){location.href='revertir_enc.php';});
							   $('#btnCambiar').bind('click',function(){location.href='lla_cambiar_sup.php';});
							   $('#btnCajero').bind('click',function(){location.href='hab_cajero.php';});
							   $('#btnSalir').bind('click',function(){location.href='salir_encargado.php';});
							   }
							   )