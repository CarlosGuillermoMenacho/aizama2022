...
//	alert('op 1');
	...
	var html=$.ajax({type:"GET",url:'get_notas_inicial.php',data:{id:idalumno},async:false}).responseText;
...
//	alert('2');
	...
	var html=$.ajax({type:"GET",url:'get_notas_alu_ini.php',data:{id4:id3},async:false}).responseText;
