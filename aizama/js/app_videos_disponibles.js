...
function getAsignarJuego(id)
{
//	alert ('po')
	var html=$.ajax({type:"GET",url:'asignar_juego.php',data:{id:id},async:false}).responseText;
	if(html=='eNoNumeric'){
...
{
	$codb = 1;
	if (getAsignarJuego($codb))
	{
			location.href='ver_videos_familia.php';   // ESTE DESHABILITE
//			location.href='materias1ro_p.php';   // ESTE DESHABILITE
...
function segundo()
{
	...
	if (getAsignarJuego($codb))
	{
			location.href='ver_videos_familia.php'; 
	}
}
function tercero()
{
	...
	if (getAsignarBimestre($codb))
	{
		...
		{
			location.href='materias3ro_p.php';   // ESTE DESHABILITE
//			location.href='aviso1.php';
		}
		else
		{
//			location.href='aviso1.php';
			location.href='materias3ro_s.php';    // ESTE DESHABILITE
		}
	}
}
function cuarto()
{
	...
	if (getAsignarBimestre($codb))
	{
		if ($('#vf_perfil').val() == 'PRIMARIA')
		{
			location.href='materias4to_p.php';   // ESTE DESHABILITE
//			location.href='aviso1.php';
		}
		else
		{
//			location.href='aviso1.php';
			location.href='materias4to_s.php';    // ESTE DESHABILITE
		}
	}
}
