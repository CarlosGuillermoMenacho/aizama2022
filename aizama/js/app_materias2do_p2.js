...
//							   $('#btn1').bind('click',function(){location.href='lenguaje.php';});
							   $('#btn2').bind('click',function(){location.href='materias2do.php';});
							   $('#btn3').bind('click',function(){location.href='examen2.php';});
							   $('#btn4').bind('click',function(){location.href='reg_notas4.php';});
