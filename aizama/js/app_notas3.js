...
{
	var html=$.ajax({type:"GET",url:'get_nota3_alu.php',data:{id4:id3,idm4:idm3},async:false}).responseText;
...
{
	var html=$.ajax({type:"GET",url:'grabar_registro3.php',data:{id1:id8,id2:id9,id3:id11,id4:id12,id5:id13,id6:id14},async:false}).responseText;
...
function regrabar(c_alu,c_mat,n1,n2,n3,n4)
{
	...
	var html=$.ajax({type:"GET",url:'actualizar_nota3.php',data:{id1:c_alu,id2:c_mat,id3:n1,id4:n2,id5:n3,id6:n4},async:false}).responseText;
	if(html=='eNoResults'){
