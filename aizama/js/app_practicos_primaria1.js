...
function lenguaje()
{
	...
	{
		location.href='ver_practicos_prim.php';
	}
}
...
function Salir()
{
	...
	else
	{
		...
		{
			location.href='materias2do_i.php';
			return true;
		}
	}
}
...
//							   $('#btn1').bind('click',function(){Volver();});
							   ...
							   $('#btn9').bind('click',function(){artesp();});
							   $('#btn10').bind('click',function(){computacion();});
							   $('#btn11').bind('click',function(){guarani();});
							   $('#btn12').bind('click',function(){ortografia();});
