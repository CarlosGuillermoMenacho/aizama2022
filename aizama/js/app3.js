...
{
	var html=$.ajax({type:"GET",url:'get_socio_rev.php',data:{id:id},async:false}).responseText;
	if(html=='eNoResults')
	{
...
{
	var html=$.ajax({type:"GET",url:'get_factura_rev.php',data:{id:idsocio},async:false}).responseText;
	if(html=='eNoResults')
	{
...
$(document).ready(function()
						   {
							   ...
							   $('#btnSalir').bind('click',function(){location.href='salir_rever.php';});
							   }
							   )