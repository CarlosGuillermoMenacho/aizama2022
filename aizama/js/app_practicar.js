...
{
	var html=$.ajax({type:"GET",url:'grabar_practicar.php',data:{id1:id8,id2:id9,id3:id11,id4:id12,id5:id13,id6:id14},async:false}).responseText;
...
//	alert('alumno: '+ $codalu +' pregunta: '+ $codpre);
  ...
  {
	var html=$.ajax({type:"GET",url:'get_grabado_practicar.php',data:{id1:$codalu,id2:$codpre},async:false}	).responseText;
...
{
//		alert ('voy : ' + id);
	var html=$.ajax({type:"GET",url:'get_datos_practicar.php',data:{id:id},async:false}).responseText;
...
//	alert ('bola 21');
	var html=$.ajax({type:"GET",url:'get_cant_practicar.php',data:{id:id1},async:false}).responseText;
//	alert ('bola 22');
...
{
//	alert('cv 1');
	var html=$.ajax({type:"GET",url:'get_practicar.php',data:{id:id},async:false}).responseText;
//	alert('cv 2');
    console.log(html);
	if(html=='eFin'){
      ...
      $('#vf_contador').val('6');
	  $('#vf_tiempo').val('9');
	  var html=$.ajax({type:"GET",url:'delete_resp_preg.php',async:false}).responseText;
	  
	  if( $('#vf_perfil').val() == 'PRIMARIA' ) {
	      location.href="inicios_prim.php";
	  } else if ( $('#vf_perfil').val() == 'SECUNDARIA' ) {
...
{
	var html=$.ajax({type:"GET",url:'get_practicar_mismo.php',data:{id:id1,id2:id3},async:false}).responseText;
...
{
	var html=$.ajax({type:"GET",url:'grabar_aban_practicar.php',data:{id1:id8,id2:id9,id3:id11,id4:id12,id5:id13,id6:id14},async:false}).responseText;
...
//	  alert('No 1');
	...
	var html=$.ajax({type:"GET",url:'borrar_aban_practicar.php',data:{id1:id8,id2:id9,id3:id11,id4:id12,id5:id13,id6:id14},async:false}).responseText;
//	  alert('No 2');
