...
//							   $('#btnLista').bind('click',function(){location.href='Lista.php';});
							   $('#btnbimestre1').bind('click',function(){location.href='reg_notas1.php?bim=1';});
							   $('#btnbimestre2').bind('click',function(){location.href='reg_notas1.php?bim=2';});
							   $('#btnbimestre3').bind('click',function(){location.href='reg_notas1.php?bim=3';});
							   $('#btnbimestre4').bind('click',function(){location.href='reg_notas1.php?bim=4';});
							   $('#btnBoletin').bind('click',function(){location.href='boletin.php';});
