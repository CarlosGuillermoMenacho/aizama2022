...
function exa1()
{
	...
	{
		location.href='advertencia_3.php';
	}
}
function exa2()
{
	...
	if (getAsignarExa($code))
	{
		location.href='advertencia_2.php';
	}
}
function exa3()
{
	...
	if (getAsignarExa($code))
	{
		location.href='advertencia_003.php';
	}
}
function exa4()
{
	...
	if (getAsignarExa($code))
	{
		location.href='advertencia_004.php';
	}
}
function exa5()
{
	...
	if (getAsignarExa($code))
	{
		location.href='advertencia_005.php';
	}
}
