...
function main () {
	...
	$('#BN1').click(function(){
		AsignarBimestre(1);
		location.href='top_calificaciones.php';
    ...
    $('#ROLE1').click(function(){
		AsignarBimestre(1);
		location.href='rol_examen_adm.php';
	...
	$('#boletin1').click(function(){
		AsignarBimestre(1);
		//location.href='boletin_materia.php';	
		location.href='centralizador_online.php';
	});
	$('#boletin2').click(function(){
		AsignarBimestre(2);
		//location.href='boletin_materia.php';	
		location.href='centralizador_online.php';
	});
	$('#boletin3').click(function(){
		AsignarBimestre(3);
		//location.href='boletin_materia.php';
		location.href='centralizador_online.php';
	});
	$('#centralizador_boletin1').click(function(){
		AsignarBimestre(1);
		location.href='boletin_materia.php';	
	});
	$('#centralizador_boletin2').click(function(){
		AsignarBimestre(2);
		location.href='boletin_materia.php';
	});
	$('#centralizador_boletin3').click(function(){
		AsignarBimestre(3);
		location.href='boletin_materia.php';
