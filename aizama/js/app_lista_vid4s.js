...
function Salir()
{
	...
	{
		location.href='materias4to_p_v.php';
		return true;
	}
	else
	{
		...
		{
			location.href='materias4to_s_v.php';
			return true;
		}
		else
		{
			location.href='materias4to_i_v.php';
			return true;
		}
	}
}
...
$(document).ready(function()
						   {
							   $('#btne1').bind('click',function(){video('1');});
