...
//		alert('2');
		var html=$.ajax({type:"GET",url:'reg_hora_entrada.php',data:{id:$('#codalu').val()},async:false}).responseText;
//		alert('3');
		if (html=='error') {
...
function getmsgalu(){
    ...
    $.get(
        ...
        (horaServidor)=>{
            ...
            var msgr = "Hora de entrada al colegio: "+horaServidor;
        ...
        "text"
            ...
            var msgr = "Hora de entrada al colegio: "+hora;
            nuevo_msg='Curso: '+nombre_curso+' - Alumno: '+nombre_alumno+' - '+msgr;
    	    let contactos = obtenerContactos(codalu);
    	    console.log(contactos);
    	    contactos.forEach((contacto)=>{
