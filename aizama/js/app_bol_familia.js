...
function getAlumnos(id)
{
	...
	var html=$.ajax({type:"GET",url:'get_alumnos_flia.php',data:{id:id},async:false}).responseText;
	if(html=='eNoResults'){
...
function get_notas(id3)
{
	...
	var html=$.ajax({type:"GET",url:'get_notas_alu_flia.php',data:{id4:id3},async:false}).responseText;
