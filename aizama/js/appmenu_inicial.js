...
function Boletin()
{
   ...
   {
	   location.href='boletin_inicial.php';
       return true;
   }
	else
	{
...
//							   $('#btnLista').bind('click',function(){location.href='Lista.php';});
							   $('#btnvideo').bind('click',function(){location.href='videos_tri.php';});
							   ...
							   $('#btnexamen').bind('click',function(){location.href='examen2.php';});
							//   $('#btnbimestre4').bind('click',function(){location.href='reg_notas4.php';});
							   $('#btnBoletin').bind('click',function(){Boletin();});
//							   $('#btnBoletin').bind('click',function(){location.href='boletin_inicial.php';});
							   $('#btnSalir').bind('click',function(){location.href='usuario.php';});
							}
							)
