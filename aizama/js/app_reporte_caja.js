...
*/
    	...
    	window.location.href = 'ver_reporte_caja.php' + "?w1=" + jsVar1 + "&w2=" + jsVar2 + "&w3=" + jsVar3 + "&w4=" + jsVar4.trim() + "&w5=" + jsVar5.trim();
		return true;
	}
	else
	{
