	...
	class CuadernoPedagogico
	{
		...
		public function get_cuaderno_pedagogico($gestion,$trimestre,$codcur,$codpar,$codmat){
		    ...
		    foreach ($lista_alumnos as $fila) {
                ...
                $notafinal = (float)$promedio_hacer + (float)$promedio_saber + (float)$nota_ser_decidir->ser+(float)$nota_ser_decidir->decidir+(float)$nota_auto_eval->ser+(float)$nota_auto_eval->decidir;
