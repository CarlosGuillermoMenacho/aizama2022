<?php 
	class CuadernoPedagogico
	{
		...
		public function get_cuaderno_pedagogico($gestion,$trimestre,$codcur,$codpar,$codmat){
		    ...
		    $total_evaluaciones = count($lista_evaluaciones_escritas)+count($lista_evaluaciones_seleccion);
		    ...
		    foreach ($lista_alumnos as $fila) {
		    	...
		    	$nota_ser_decidir = $this->get_nota_ser_decidir($codalu,$lista_ser_decidir_alumnos);
		    	$nota_auto_eval = $this->get_nota_autoeval($codalu,$lista_auto_eval_alumno);
		    	...
		    	$promedio_saber =$total_evaluaciones == 0 ? 0: $this->promedio_saber($lista_notas_eval_seleccion,$lista_notas_eval_escrito)/$total_evaluaciones;
		...
		function promedio_saber($lista_notas_eval_seleccion,$lista_notas_eval_escrito){
			$nota = 0;
			$cont = 0;
