...
class Material{
	...
	public function get_material_gestion_materia($gestion,$codcur,$codpar,$codmat){
		$sql = "SELECT * FROM material_de_apoyo WHERE gestion = ? AND estado = 1 AND codcur = ? AND codpar = ? AND codmat = ? ORDER BY trimestre ASC";
		$type = "iiis";
