...
class PreInscripcion{
	...
	public function get_bloqueado_alu($codalu,$gestion){
/*		$sql = "SELECT id_usr as codalu,2023 as gestion,1 as inscripcion,1 as estado,servernt 
				FROM usr 
				WHERE id_usr = 2449 and servernt = 'VERDADERO'";
*/
		$sql = "SELECT * 
				FROM pre_inscripcion 
